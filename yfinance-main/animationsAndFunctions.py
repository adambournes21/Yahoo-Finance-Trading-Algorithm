...
#does not work for gap years, but it's fine because we only used ytd
#needs to return format "2020-11-06" or "YYYY-MM-DD"
...
def addDividends(portfolio, day):
    return 5
...
def drawAAPLMACDPortfolioGraph(app, canvas):
    canvas.create_line(160, 320, 160, 540, width = 3) # y axis
    canvas.create_line(160, 540, 380, 540, width = 3) # x axis
    #top left is 160, 320
    #bottom left is 160, 540
    #the middle is y = 430 and x = 270
    #height and width are  220
    canvas.create_text(130, 325, text = '$120,000')
    canvas.create_line(160, 320, 380, 320)
    canvas.create_text(130, 375, text = '$110,000')
    canvas.create_line(160, 375, 380, 375)
    canvas.create_text(130, 430, text = '$100,000')
    canvas.create_line(160, 430, 380, 430)
    canvas.create_text(130, 485, text = '$90,000')
    canvas.create_line(160, 485, 380, 485)
    canvas.create_text(130, 540, text = '$80,000')
    previousLineData = []
    for i in range(len(app.AAPLMACDPortfolioValueList)):
        if i != 0:
            canvas.create_line(previousLineData[0], previousLineData[1], \
            160 + 220 * i / len(app.AAPLMACDPortfolioValueList) + app.graphCircleRadius, \
            430 + (100000 - app.AAPLMACDPortfolioValueList[i]) / 200 + app.graphCircleRadius, \
            width = 3)

        previousLineData = [160 + 220 * i / len(app.AAPLMACDPortfolioValueList) + app.graphCircleRadius / 2, \
            430 + (100000 - app.AAPLMACDPortfolioValueList[i]) / 200 + app.graphCircleRadius / 2,]
...
def drawMACDPortfolioGraph(app, canvas):
    canvas.create_line(160, 50, 160, 270, width = 3) # y axis
    canvas.create_line(160, 270, 380, 270, width = 3) # x axis
    #top left is 160, 60
    #bottom left is 160, 270
    #the middle is y = 160 and x = 270
    #height and width are  220
    canvas.create_text(130, 55, text = '$120,000')
    canvas.create_line(160, 50, 380, 50)
    canvas.create_text(130, 108, text = '$110,000')
    canvas.create_line(160, 108, 380, 108)
    canvas.create_text(130, 160, text = '$100,000')
    canvas.create_line(160, 160, 380, 160)
    canvas.create_text(130, 212, text = '$90,000')
    canvas.create_line(160, 212, 380, 212)
    canvas.create_text(130, 265, text = '$80,000')
    previousLineData = []
    for i in range(len(app.MACDPortfolioValueList)):
        if i != 0:
            canvas.create_line(previousLineData[0], previousLineData[1], \
            160 + 220 * i / len(app.MACDPortfolioValueList) + app.graphCircleRadius, \
            160 + (100000 - app.MACDPortfolioValueList[i]) / 200 + app.graphCircleRadius, \
            width = 3)

        previousLineData = [160 + 220 * i / len(app.MACDPortfolioValueList) + app.graphCircleRadius / 2, \
            160 + (100000 - app.MACDPortfolioValueList[i]) / 200 + app.graphCircleRadius / 2,]
...
def drawRSIPortfolioGraphRandom(app, canvas):
    canvas.create_line(160, 50, 160, 270, width = 3) # y axis
    canvas.create_line(160, 270, 380, 270, width = 3) # x axis
    #top left is 160, 60
    #bottom left is 160, 270
    ...
    for i in range(len(app.MACDPortfolioValueList)):
        if i != 0:
            canvas.create_line(previousLineData[0], previousLineData[1], \
            160 + 220 * i / len(app.RSIPortfolioValueList) + app.graphCircleRadius, \
            160 + (100000 - app.RSIPortfolioValueList[i]) / 200 + app.graphCircleRadius, \
            width = 3)

        previousLineData = [160 + 220 * i / len(app.RSIPortfolioValueList) + app.graphCircleRadius / 2, \
            160 + (100000 - app.RSIPortfolioValueList[i]) / 200 + app.graphCircleRadius / 2,]
    

def drawMSFTRSIPortfolioGraph(app, canvas):
    canvas.create_line(160, 320, 160, 540, width = 3) # y axis
    canvas.create_line(160, 540, 380, 540, width = 3) # x axis
    #top left is 160, 320
    #bottom left is 160, 540
    ...
    canvas.create_text(130, 540, text = '$80,000')
    previousLineData = []
    for i in range(len(app.MSFTRSIPortfolioValueList)):
        if i != 0:
            canvas.create_line(previousLineData[0], previousLineData[1], \
            160 + 220 * i / len(app.MSFTRSIPortfolioValueList) + app.graphCircleRadius, \
            430 + (100000 - app.MSFTRSIPortfolioValueList[i]) / 200 + app.graphCircleRadius, \
            width = 3)

        previousLineData = [160 + 220 * i / len(app.MSFTRSIPortfolioValueList) + app.graphCircleRadius / 2, \
            430 + (100000 - app.MSFTRSIPortfolioValueList[i]) / 200 + app.graphCircleRadius / 2,]
...
def drawMarketAverageGraph(app, canvas):
    canvas.create_line(460, 50, 460, 270, width = 3) # y axis
    canvas.create_line(460, 270, 680, 270, width = 3) # x axis
    #top left is 460, 50
    #bottom left is 460, 270
    #the middle is y = 160 and x = 570
    #height and width are  220
    #these below are the combo of y-axis labels and lines to make graph easier to read at that label
    canvas.create_text(430, 55, text = '$120,000')
    canvas.create_line(460, 50, 680, 50)
    canvas.create_text(430, 108, text = '$110,000')
    canvas.create_line(460, 108, 680, 108)
    canvas.create_text(430, 160, text = '$100,000')
    canvas.create_line(460, 160, 680, 160)
    canvas.create_text(430, 212, text = '$90,000')
    canvas.create_line(460, 212, 680, 212)
    canvas.create_text(430, 265, text = '$80,000')
    previousLineData = []

    for i in range(len(app.indexValueList)):
        if i != 0:
            canvas.create_line(previousLineData[0], previousLineData[1], \
            460 + 220 * i / len(app.indexValueList) + app.graphCircleRadius / 2, \
            160 + (100000 - app.indexValueList[i]) / 200 + app.graphCircleRadius / 2, \
            width = 3)

        previousLineData = [460 + 220 * i / len(app.indexValueList) + app.graphCircleRadius / 2, \
            160 + (100000 - app.indexValueList[i]) / 200 + app.graphCircleRadius / 2,]
...
def drawStockGraph(app, canvas, left, top, width, height, ticker):
    if getHighestValue(app, ticker) < (app.stockData[ticker]['Close'][0] * 1.05) and getLowestValue(app, ticker) > (app.stockData[ticker]['Close'][0] * .95):
        ...
        canvas.create_text(left - 30, top + 5, text = '$110,000')
        canvas.create_line(left, top, left + width, top)
        canvas.create_text(left - 30, top + height / 4 + 3, text = '$1105,000')
        canvas.create_line(left, top + height / 4 + 3, left + width, top + height / 4 + 3)
        canvas.create_text(left - 30, top + height / 2, text = '$100,000')
        canvas.create_line(left, top + height / 2, left + width, top + height / 2)
        canvas.create_text(left - 30, top + 3 * height / 4 - 3, text = '$95,000')
        ...
        canvas.create_text(left - 30, top + 5, text = '$150,000')
        canvas.create_line(left, top, left + width, top)
        canvas.create_text(left - 30, top + height / 4 + 3, text = '$1250,000')
        canvas.create_line(left, top + height / 4 + 3, left + width, top + height / 4 + 3)
        canvas.create_text(left - 30, top + height / 2, text = '$100,000')
        canvas.create_line(left, top + height / 2, left + width, top + height / 2)
        canvas.create_text(left - 30, top + 3 * height / 4 - 3, text = '$75,000')
...
def drawStockGraphUserPage(app, canvas, left, top, width, height, ticker):
    point0 = round(app.stockData[ticker]['Close'][0] * .0, 2)
...
def timerFired(app):
    if app.screen == 1:
        if app.day < int(app.period[:-1]) - 1:
            ...
            if app.day > 1:
                app.LRIndex = calculateLeastSquaresRegression(app, app.indexValueList)
                app.LRMACD = calculateLeastSquaresRegression(app, app.MACDPortfolioValueList)
                app.LRAAPLMACD = calculateLeastSquaresRegression(app, app.AAPLMACDPortfolioValueList)
                app.LRAAPL = calculateLeastSquaresRegression(app, app.stockValuesList['AAPL'])
    ...
    if app.screen == 2:
        if app.day < int(app.period[:-1]) - 1:
            ...
            if app.day > 1:
                app.LRIndex = calculateLeastSquaresRegression(app, app.indexValueList)
                #app.LRRSI = calculateLeastSquaresRegression(app, app.RSIPortfolioValueList)
                app.LRMSFTRSI = calculateLeastSquaresRegression(app, app.MSFTRSIPortfolioValueList)
                print(calculateLeastSquaresRegression(app, app.stockValuesList['MSFT']))
                app.LRMSFT = calculateLeastSquaresRegression(app, app.stockValuesList['MSFT'])
    ...
    if app.screen == 3:
        if app.day < int(app.period[:-1]) - 1:
            ...
            if app.day > 1:
                app.LRIndex = calculateLeastSquaresRegression(app, app.indexValueList)
                #app.LRGC = calculateLeastSquaresRegression(app, app.GCPortfolioValueList)
                app.LRAMZNGC = calculateLeastSquaresRegression(app, app.AMZNGCPortfolioValueList)
                app.LRAMZN = calculateLeastSquaresRegression(app, app.stockValuesList['AMZN'])
...
def redrawAll(app, canvas):
    if app.screen == 0:
        ...
        canvas.create_rectangle(0, 0, app.width, app.height, fill = '#34E691')
        ...
        canvas.create_rectangle(app.width / 4.5, 19 * app.height / 64, 
            app.width / 4.5 + app.startButtonWidth, 19 * app.height / 64 + app.startButtonHeight, fill = '#CB98E6', width = 1)
        ...
        canvas.create_rectangle(app.width / 4.5, 32 * app.height / 64, 
            app.width / 4.5 + app.startButtonWidth, 32 * app.height / 64 + app.startButtonHeight, fill = '#CB98E6', width = 1)
        ...
        canvas.create_rectangle(app.width / 4.5, 45 * app.height / 64, 
            app.width / 4.5 + app.startButtonWidth, 45 * app.height / 64 + app.startButtonHeight, fill = '#CB98E6', width = 1)
        ...
        canvas.create_rectangle(3.5 * app.width / 4.5, 19 * app.height / 64, 
            3.5 * app.width / 4.5 - app.startButtonWidth, 19 * app.height / 64 + app.startButtonHeight, fill = '#CB98E6', width = 1)
        canvas.create_text(3.5 * app.width / 4.5 - app.startButtonWidth / 2, 19 * app.height / 64 + app.startButtonHeight / 2, \
    ...
    if app.screen == 2: #RSI
        ...
        if app.LRMSFT == 0:
            ...
            canvas.create_text(570, 556, text = f'LR MSFT: 100000 {app.LRMSFT}')
        canvas.create_text(55, 78, text = f'day: {app.day}')
        #drawPortfolioGraph(app, canvas, 160, 50, 220, 220, app.RSIPortfolioValueList)
        #drawMSFTRSIPortfolioGraph(app, canvas)
        #drawMarketAverageGraph(app, canvas)
        ...
        #drawRSIPortfolioGraphRandom(app, canvas)
